...
HRESULT Phantom::D3d12GraphicsManager::CreateDepthStencil()
{
    ...
    uint32_t width = g_pApp->GfxCfg().screenWidth;
    uint32_t height = g_pApp->GfxCfg().screenHeight;
...
HRESULT Phantom::D3d12GraphicsManager::CreateGraphicsResources()
{
    ...
    scd.Width = g_pApp->GfxCfg().screenWidth;
    scd.Height = g_pApp->GfxCfg().screenHeight;
